...
export const LinkFooter: React.FC<{
  ...
  return (
    <div className='link-footer'>
      ...
      <p>
        <strong>Fedired</strong>:{' '}
        <a href='https://help.fedired.com' target='_blank' rel='noopener'>
          <FormattedMessage id='footer.about' defaultMessage='About' />
        </a>
        <DividingCircle />
        <a href='https://help.fedired.com/fed/apps' target='_blank' rel='noopener'>
