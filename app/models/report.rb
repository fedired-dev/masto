...
class Report < ApplicationRecord
  ...
  # - app/javascript/fedired/features/notifications/components/report.jsx
  # - app/javascript/fedired/features/report/category.jsx
  # - app/javascript/fedired/components/admin/ReportReasonSelector.jsx
  enum :category, {
    other: 0,
    spam: 1_000,
    legal: 1_500,
