  ...
  describe '#call' do
    ...
    context 'when registrations are closed' do
      ...
      it 'raises an error', :aggregate_failures do
        expect { subject.call(app, remote_ip, good_params) }.to raise_error Fedired::NotPermittedError
      end
      ...
      context 'when using an invalid invite' do
        ...
        it 'raises an error', :aggregate_failures do
          expect { subject.call(app, remote_ip, params) }.to raise_error Fedired::NotPermittedError
        end
      end
    end
