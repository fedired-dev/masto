...
require 'fedired/cli/accounts'

RSpec.describe Fedired::CLI::Accounts do
    ...
    context 'with a list of accts' do
      ...
      context 'when an UnexpectedResponseError is raised' do
        it 'displays a failure message' do
          allow(account_example_com_a).to receive(:reset_avatar!).and_raise(Fedired::UnexpectedResponseError)
  ...
  describe '#cull' do
    ...
    context 'when a domain is unavailable' do
      ...
      context 'when a private network address error occurs' do
        before do
          stub_request(:head, 'https://example.net/users/tales').to_raise(Fedired::PrivateNetworkAddressError)
        end
