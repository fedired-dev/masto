  ...
  context 'when response size exceeds limit' do
    context 'with Content-Length header' do
      ...
      it 'raises without reading the body' do
        ...
        expect { subject }.to raise_error(Fedired::LengthValidationError, 'Content-Length 5242880 exceeds limit of 51200')
    ...
    context 'without Content-Length header' do
      ...
      it 'raises while reading the body' do
        expect { subject }.to raise_error(Fedired::LengthValidationError, 'Body size exceeds limit of 51200')
