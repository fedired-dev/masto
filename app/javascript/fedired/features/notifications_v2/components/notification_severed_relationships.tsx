import { RelationshipsSeveranceEvent } from 'fedired/features/notifications/components/relationships_severance_event';
import type { NotificationGroupSeveredRelationships } from 'fedired/models/notification_group';
