...
class Api::V1::FiltersController < Api::BaseController
  ...
  def update
    ApplicationRecord.transaction do
      ...
      raise Fedired::ValidationError, I18n.t('filters.errors.deprecated_api_multiple_keywords') if @filter.custom_filter.changed? && @filter.custom_filter.keywords.count > 1
