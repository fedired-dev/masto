  ...
  describe '.new_software_updates' do
    ...
    it 'renders the email' do
      expect(mail)
        ...
        .and(deliver_to(recipient.user_email))
        .and(deliver_from('notifications@localhost'))
        .and(have_subject('New Fedired versions are available for cb6e6126.ngrok.io!'))
        .and(have_body_text('New Fedired versions have been released, you may want to update!'))
    end
  end
  ...
  describe '.new_critical_software_updates' do
    ...
    it 'renders the email' do
      expect(mail)
        ...
        .and(deliver_to(recipient.user_email))
        .and(deliver_from('notifications@localhost'))
        .and(have_subject('Critical Fedired updates are available for cb6e6126.ngrok.io!'))
        .and(have_body_text('New critical versions of Fedired have been released, you may want to update as soon as possible!'))
