...
module ThemeHelper
  def theme_style_tags(theme)
    if theme == 'system'
      ''.html_safe.tap do |tags|
        tags << stylesheet_pack_tag('fedired-light', media: 'not all and (prefers-color-scheme: dark)', crossorigin: 'anonymous')
  ...
  def theme_color_for(theme)
    theme == 'fedired-light' ? Themes::THEME_COLORS[:light] : Themes::THEME_COLORS[:dark]
  end
end
