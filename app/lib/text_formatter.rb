...
class TextFormatter
  ...
  def to_s
    ...
    html = nil
    FediredOTELTracer.in_span('TextFormatter#to_s extract_and_rewrite') do
    ...
    if multiline?
      FediredOTELTracer.in_span('TextFormatter#to_s simple_format') do
  ...
  def link_to_url(entity)
    FediredOTELTracer.in_span('TextFormatter#link_to_url') do
      TextFormatter.shortened_link(entity[:url], rel_me: with_rel_me?)
    end
  end

  def link_to_hashtag(entity)
    FediredOTELTracer.in_span('TextFormatter#link_to_hashtag') do
  ...
  def link_to_mention(entity)
    FediredOTELTracer.in_span('TextFormatter#link_to_mention') do
