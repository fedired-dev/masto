...
class Api::V1::StatusesController < Api::BaseController
  ...
  rescue Fedired::NotPermittedError
    not_found
  end
  ...
  rescue ActiveRecord::RecordNotFound, Fedired::NotPermittedError
    render json: { error: I18n.t('statuses.errors.in_reply_not_found') }, status: 404
  end

  def check_statuses_limit
    raise(Fedired::ValidationError) if status_ids.size > DEFAULT_STATUSES_LIMIT
  end
