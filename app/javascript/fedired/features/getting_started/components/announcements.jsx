...
import { AnimatedNumber } from 'fedired/components/animated_number';
import { Icon }  from 'fedired/components/icon';
import { IconButton } from 'fedired/components/icon_button';
import EmojiPickerDropdown from 'fedired/features/compose/containers/emoji_picker_dropdown_container';
import { unicodeMapping } from 'fedired/features/emoji/emoji_unicode_mapping_light';
import { autoPlayGif, reduceMotion, disableSwiping, mascot } from 'fedired/initial_state';
import { assetHost } from 'fedired/utils/config';
  ...
  render () {
    ...
    return (
      <div className='announcements'>
        <img className='announcements__fedired' alt='' draggable='false' src={mascot || elephantUIPlane} />
