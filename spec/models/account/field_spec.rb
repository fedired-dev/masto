  ...
  describe '#verifiable?' do
    ...
    context 'with local accounts' do
      ...
      context 'with a URL with a non-normalized path' do
        let(:value) { 'https://github.com/octocatxxxxxxxx/../fedired' }
    ...
    context 'with remote accounts' do
      ...
      context 'with a link' do
        let(:value) { '<a href="https://www.patreon.com/fedired" target="_blank" rel="nofollow noopener noreferrer me"><span class="invisible">https://www.</span><span class="">patreon.com/fedired</span><span class="invisible"></span></a>' }
