...
class AccountStatusesCleanupPolicy < ApplicationRecord
  ...
  def compute_cutoff_id
    ...
    max_id = Fedired::Snowflake.id_at(min_status_age.seconds.ago, with_random: false)
  ...
  def old_enough_scope(max_id = nil)
    ...
    # non-snowflake statuses as older than they really are, but Fedired
    # has switched to snowflake IDs significantly over 2 years ago anyway.
    snowflake_id = Fedired::Snowflake.id_at(min_status_age.seconds.ago, with_random: false)
