...
} from 'fedired/actions/importer';
import { apiRequestGet, apiRequestPost } from 'fedired/api';
import { LoadingIndicator } from 'fedired/components/loading_indicator';
import { me } from 'fedired/initial_state';
import type { Account } from 'fedired/models/account';
import type { AnnualReport as AnnualReportData } from 'fedired/models/annual_report';
import type { Status } from 'fedired/models/status';
      ...
      <div className='annual-report__header'>
        <h1>
          <FormattedMessage
            ...
            defaultMessage='Thanks for being part of Fedired!'
          />
        </h1>
        <p>
          <FormattedMessage
