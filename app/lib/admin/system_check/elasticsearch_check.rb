...
class Admin::SystemCheck::ElasticsearchCheck < Admin::SystemCheck::BaseCheck
  ...
  def message
    if running_version.blank?
      ...
      Admin::SystemCheck::Message.new(:elasticsearch_preset_single_node, nil, 'https://docs.joinfedired.org/admin/elasticsearch/#scaling')
      ...
      Admin::SystemCheck::Message.new(:elasticsearch_preset, nil, 'https://docs.joinfedired.org/admin/elasticsearch/#scaling')
    end
  rescue Faraday::ConnectionFailed, Elasticsearch::Transport::Transport::Error
    Admin::SystemCheck::Message.new(:elasticsearch_running_check)
  end
