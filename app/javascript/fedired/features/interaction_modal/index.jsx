...
import { openModal, closeModal } from 'fedired/actions/modal';
import api from 'fedired/api';
import { Button } from 'fedired/components/button';
import { Icon }  from 'fedired/components/icon';
import { registrationsOpen, sso_redirect } from 'fedired/initial_state';

const messages = defineMessages({
  loginPrompt: { id: 'interaction_modal.login.prompt', defaultMessage: 'Domain of your home server, e.g. fedired.social' },
});
...
class InteractionModal extends React.PureComponent {
  ...
  render () {
    ...
    case 'reply':
      ...
      actionDescription = <FormattedMessage id='interaction_modal.description.reply' defaultMessage='With an account on Fedired, you can respond to this post.' />;
      break;
    case 'reblog':
      ...
      actionDescription = <FormattedMessage id='interaction_modal.description.reblog' defaultMessage='With an account on Fedired, you can boost this post to share it with your own followers.' />;
      break;
    case 'favourite':
      ...
      actionDescription = <FormattedMessage id='interaction_modal.description.favourite' defaultMessage='With an account on Fedired, you can favorite this post to let the author know you appreciate it and save it for later.' />;
      break;
    case 'follow':
      icon = <Icon id='user-plus' icon={PersonAddIcon} />;
      title = <FormattedMessage id='interaction_modal.title.follow' defaultMessage='Follow {name}' values={{ name }} />;
      actionDescription = <FormattedMessage id='interaction_modal.description.follow' defaultMessage='With an account on Fedired, you can follow {name} to receive their posts in your home feed.' values={{ name }} />;
      break;
    case 'vote':
      ...
      actionDescription = <FormattedMessage id='interaction_modal.description.vote' defaultMessage='With an account on Fedired, you can vote in this poll.' />;
      break;
    }
    ...
    return (
      <div className='modal-root__modal interaction-modal'>
        ...
        <p className='hint'><FormattedMessage id='interaction_modal.sign_in_hint' defaultMessage="Tip: That's the website where you signed up. If you don't remember, look for the welcome e-mail in your inbox. You can also enter your full username! (e.g. @fedired@fedired.social)" /></p>
        <p><FormattedMessage id='interaction_modal.no_account_yet' defaultMessage='Not on Fedired?' /> {signupButton}</p>
      </div>
    );
  }
