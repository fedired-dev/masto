...
import { afterInitialRender } from 'fedired/../hooks/useRenderSignal';

import { start } from '../fedired/common';
import { Status } from '../fedired/features/standalone/status';
...
function loaded() {
  const mountNode = document.getElementById('fedired-status');
