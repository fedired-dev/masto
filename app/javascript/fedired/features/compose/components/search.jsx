...
import { domain, searchEnabled } from 'fedired/initial_state';
import { HASHTAG_REGEX } from 'fedired/utils/hashtags';
...
class Search extends PureComponent {
  ...
  _calculateOptions (value) {
    ...
    if (trimmedValue.length > 0) {
      ...
      if (couldBeURL) {
        options.push({ key: 'open-url', label: <FormattedMessage id='search.quick_action.open_url' defaultMessage='Open URL in Fedired' />, action: this.handleURLClick });
      }
