...
class RelationshipFilter
  ...
  def scope_for(key, value)
    ...
    when 'activity'
      ...
      raise Fedired::InvalidParameterError, "Unknown filter: #{key}"
    end
  end
  ...
  def relationship_scope(value)
    ...
    when 'invited'
      ...
      raise Fedired::InvalidParameterError, "Unknown relationship: #{value}"
    end
  end
  ...
  def location_scope(value)
    ...
    when 'remote'
      ...
      raise Fedired::InvalidParameterError, "Unknown location: #{value}"
    end
  end
  ...
  def status_scope(value)
    ...
    when 'primary'
      ...
      raise Fedired::InvalidParameterError, "Unknown status: #{value}"
    end
  end
  ...
  def order_scope(value)
    ...
    when 'recent'
      ...
      raise Fedired::InvalidParameterError, "Unknown order: #{value}"
    end
  end
  ...
  def activity_scope(value)
    ...
    when 'dormant'
      ...
      raise Fedired::InvalidParameterError, "Unknown activity: #{value}"
    end
  end
end
