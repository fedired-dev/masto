...
import { timeAgoString } from '../fedired/components/relative_timestamp';
import emojify from '../fedired/features/emoji/emoji';
import loadKeyboardExtensions from '../fedired/load_keyboard_extensions';
import { loadLocale, getLocale } from '../fedired/locales';
...
function loaded() {
  ...
  if (reactComponents.length > 0) {
    import(
      /* webpackChunkName: "containers/media_container" */ '../fedired/containers/media_container'
    )
