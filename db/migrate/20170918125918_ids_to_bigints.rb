...
require_relative '../../lib/fedired/migration_helpers'
require_relative '../../lib/fedired/migration_warning'

class IdsToBigints < ActiveRecord::Migration[5.1]
  include Fedired::MigrationHelpers
  include Fedired::MigrationWarning
  ...
  def display_warning
    migration_duration_warning(<<~EXPLANATION)
      ...
      For more information, see https://github.com/fedired/fedired/pull/5088
    EXPLANATION
  end
