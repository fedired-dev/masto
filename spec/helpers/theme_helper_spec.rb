...
RSpec.describe ThemeHelper do
  describe 'theme_style_tags' do
    ...
    context 'when using system theme' do
      ...
      it 'returns the fedired-light and default stylesheets with correct color schemes' do
        expect(html_links.first.attributes.symbolize_keys)
          .to include(
            href: have_attributes(value: match(/fedired-light/)),
  ...
  describe 'theme_color_tags' do
    ...
    context 'when using fedired-light theme' do
      let(:theme) { 'fedired-light' }
