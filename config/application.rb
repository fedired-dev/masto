...
require_relative '../lib/fedired/snowflake'
require_relative '../lib/fedired/version'
require_relative '../lib/fedired/rack_middleware'
...
require_relative '../lib/chewy/strategy/fedired'
...
module Fedired
  class Application < Rails::Application
    ...
    config.middleware.use Fedired::RackMiddleware
    ...
    config.x.fedired = config_for(:fedired)
