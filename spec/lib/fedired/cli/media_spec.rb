...
require 'fedired/cli/media'

RSpec.describe Fedired::CLI::Media do
  ...
  describe '#refresh' do
    ...
    context 'with --days option' do
      before do
        Fabricate(:media_attachment, remote_url: 'https://example.com/image.jpg', id: Fedired::Snowflake.id_at(50.days.ago))
        Fabricate(:media_attachment, remote_url: 'https://example.com/image.jpg', id: Fedired::Snowflake.id_at(5.days.ago))
        Fabricate(:media_attachment, remote_url: '', id: Fedired::Snowflake.id_at(5.days.ago))
      end
