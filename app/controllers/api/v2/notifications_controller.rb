...
class Api::V2::NotificationsController < Api::BaseController
  ...
  def index
    ...
    FediredOTELTracer.in_span('Api::V2::NotificationsController#index rendering') do |span|
  ...
  def load_notifications
    FediredOTELTracer.in_span('Api::V2::NotificationsController#load_notifications') do
  ...
  def load_grouped_notifications
    ...
    FediredOTELTracer.in_span('Api::V2::NotificationsController#load_grouped_notifications') do
  ...
  def expand_accounts_param
    ...
    when 'partial_avatars'
      ...
      raise Fedired::InvalidParameterError, "Invalid value for 'expand_accounts': '#{params[:expand_accounts]}', allowed values are 'full' and 'partial_avatars'"
    end
  end
end
