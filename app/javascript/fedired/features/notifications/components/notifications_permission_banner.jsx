...
import { requestBrowserPermission } from 'fedired/actions/notifications';
  ...
  render () {
    ...
    return (
      <div className='notifications-permission-banner'>
        ...
        <p><FormattedMessage id='notifications_permission_banner.how_to_control' defaultMessage="To receive notifications when Fedired isn't open, enable desktop notifications. You can control precisely which types of interactions generate desktop notifications through the {icon} button above once they're enabled." values={{ icon: <Icon id='sliders' icon={SettingsIcon} /> }} /></p>
