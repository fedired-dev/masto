...
module JsonLdHelper
  ...
  #
  # Since compacting a JSON-LD document against Fedired's built-in vocabulary
  ...
  #   'as:Public' (for instance, pre-3.4.0 Fedired does not understand
  #   'as:Public')
  ...
  def fetch_resource_without_id_validation(uri, on_behalf_of = nil, raise_on_temporary_error = false, request_options: {})
    ...
    build_request(uri, on_behalf_of, options: request_options).perform do |response|
      raise Fedired::UnexpectedResponseError, response unless response_successful?(response) || response_error_unsalvageable?(response) || !raise_on_temporary_error
