...
class ApplicationController < ActionController::Base
  ...
  rescue_from Fedired::NotPermittedError, with: :forbidden
  rescue_from ActionController::RoutingError, ActiveRecord::RecordNotFound, with: :not_found
  rescue_from ActionController::UnknownFormat, with: :not_acceptable
  rescue_from ActionController::InvalidAuthenticityToken, with: :unprocessable_entity
  rescue_from Fedired::RateLimitExceededError, with: :too_many_requests

  rescue_from(*Fedired::HTTP_CONNECTION_ERRORS, with: :internal_server_error)
  rescue_from Fedired::RaceConditionError, Stoplight::Error::RedLight, ActiveRecord::SerializationFailure, with: :service_unavailable
