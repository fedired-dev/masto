    ...
    context 'with since_id' do
      context 'when requesting old posts' do
        it 'returns conversations' do
          get '/api/v1/conversations', params: { since_id: Fedired::Snowflake.id_at(1.hour.ago, with_random: false) }, headers: headers
      ...
      context 'when requesting posts in the future' do
        it 'returns no conversation' do
          get '/api/v1/conversations', params: { since_id: Fedired::Snowflake.id_at(1.hour.from_now, with_random: false) }, headers: headers
