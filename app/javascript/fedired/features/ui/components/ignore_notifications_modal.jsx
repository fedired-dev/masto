...
import { closeModal } from 'fedired/actions/modal';
import { updateNotificationsPolicy } from 'fedired/actions/notification_policies';
  ...
  return (
    <div className='modal-root__modal safety-action-modal'>
      <div className='safety-action-modal__top'>
        ...
        <div>
          <FormattedMessage id='ignore_notifications_modal.disclaimer' defaultMessage="Fedired cannot inform users that you've ignored their notifications. Ignoring notifications will not stop the messages themselves from being sent." />
        </div>
      </div>
