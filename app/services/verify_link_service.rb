...
class VerifyLinkService < BaseService
  def call(field)
    ...
    field.mark_verified!
  rescue *Fedired::HTTP_CONNECTION_ERRORS, Addressable::URI::InvalidURIError, Fedired::HostValidationError, Fedired::LengthValidationError, IPAddr::AddressFamilyError => e
